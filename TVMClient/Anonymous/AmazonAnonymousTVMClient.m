...
@implementation AmazonAnonymousTVMClient
...
-(Response *)anonymousRegister
{
    ...
    if ( [AmazonTVMKeyChainWrapper getUidForDevice] == nil) {
        ...
        if ( [response wasSuccessful]) {
            [AmazonTVMKeyChainWrapper registerDeviceId:uid andKey:key];
        }
        else {
...
-(Response *)getToken
{
    ...
    Request          *request = [[GetAnonymousTokenRequest alloc] initWithEndpoint:self.endpoint andUid:uid andKey:key usingSSL:self.useSSL];
