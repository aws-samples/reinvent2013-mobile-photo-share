...
/**
 * This class is used to generate encryption key (in identity use case) and send
...
public class LoginServlet extends RootServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            tvm.validateLoginRequest(username, uid, signature, timestamp);

            log.info("Get key for user: " + username);
            String data = tvm.getKey(username, uid);
