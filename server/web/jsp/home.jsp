    ...
    <body class="success">
		...
		<div id="body">
			<fieldset>
				...
				<p class="message">Mobile Photo Share Server is running.</p>
			</fieldset>
		</div>
		
		<% if( Utilities.isEmpty(Configuration.AWS_ACCESS_KEY_ID) || Utilities.isEmpty(Configuration.AWS_SECRET_KEY) ) {%>
		<p class="warning">Warning: Your Mobile Photo Share Server is not properly configured.</p>
		<%} %>
		...
		<div id="footer">
			<p class="footnote"><%=Configuration.APP_NAME %> - Mobile Photo Share Server</p>
		</div>
    </body>
