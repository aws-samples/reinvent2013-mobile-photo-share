...
@property (nonatomic, readonly) AmazonS3Client *s3;
@property (nonatomic, readonly) AmazonDynamoDBClient *ddb;
@property (nonatomic, readonly) AmazonSNSClient *sns;
@property (nonatomic, readonly) S3TransferManager *transferManager;
